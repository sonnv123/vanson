(function ($) {
    var _tinhthanhService = abp.services.app.dmTinhThanh,
        l = abp.localization.getSource('vanson'),
        _$modal = $('#TenantCreateModal'),
        _$form = _$modal.find('form'),
        _$table = $('#TinhThanhsTable');
    var _$tenantsTable = _$table.DataTable({
        paging: true,
        serverSide: true,
        listAction: {
            ajaxFunction: _tinhthanhService.getAll,
        ...
        columnDefs: [
            ...
            {
                targets: 2,
                data: 'tinhThanh_tentat',
                sortable: false
            },
            {
                targets: 3,
                data: 'tinhThanh_batdau',
                sortable: false
            },
            {
                targets: 4,
                data: 'tinhThanh_ketthuc',
                sortable: false
            },
            {
                targets: 5,
                data: 'tinhThanh_hieuluc',
                sortable: false
            },
            {
                 targets: 6,
