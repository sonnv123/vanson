...
{
    public abstract class vansonWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static vansonWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(vansonWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<vansonDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<vansonDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<vansonDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<vansonDbContext, Task<T>> func)
        {
            T result;
